...
_SHORTCUT_META: dict[str, dict[str, str]] = {
    ...
    "4": {"url": "../cars_manage/manual_fault_maintenance.html", "icon": "./images/svg/icon-carmanage.svg"},
    "411": {"url": "../cars_manage/violation_manual_entry.html", "icon": "./images/svg/icon-carmanage.svg"},
    "412": {"url": "../cars_manage/violation_manual_handle.html", "icon": "./images/svg/icon-carmanage.svg"},
    "413": {"url": "../cars_manage/violation_result_audit.html", "icon": "./images/svg/icon-carmanage.svg"},
    "414": {"url": "../cars_manage/violation_appeal.html", "icon": "./images/svg/icon-carmanage.svg"},
    "431": {"url": "../cars_manage/manual_fault_maintenance.html", "icon": "./images/svg/icon-carmanage.svg"},
    "433": {"url": "../cars_manage/fault_audit.html", "icon": "./images/svg/icon-carmanage.svg"},
