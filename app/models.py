...
class Vehicle(Base):
    ...
    product_model_code = Column(String(64), nullable=True)
    frame_no = Column(String(64), nullable=True)
    vehicle_type_code = Column(String(32), nullable=True)
    vehicle_length = Column(Numeric(10, 2), nullable=True)
    vehicle_width = Column(Numeric(10, 2), nullable=True)
    vehicle_height = Column(Numeric(10, 2), nullable=True)
    loaded_weight = Column(Numeric(12, 2), nullable=True)
